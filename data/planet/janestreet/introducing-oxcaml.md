...
description: "At Jane Street, we\u2019ve been actively making improvements to OCaml
  for a long time. Over the last few years, we\u2019ve started to build some fairly
  ambitious exten..."
...
<p>At Jane Street, we&rsquo;ve been actively making improvements to OCaml for a long time. Over the
last few years, we&rsquo;ve started to build some fairly ambitious extensions to the
...
upstream OCaml</strong>, but we&rsquo;re still iterating on their design as we gain experience using
