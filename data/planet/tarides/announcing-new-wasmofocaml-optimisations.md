...
description: Discover the optimisations we brought to Wasm_of_ocaml in 2025, improving
  the performance of OCaml bytecode compiled to WebAssembly.
...
<p><img src="https://tarides.com/blog/images/CAMLBoy-bench-1360w~ZKIIldzmpp7-z09HOdethg.webp" sizes="(min-width: 1360px) 1360px, (min-width: 680px) 680px, 100vw" srcset="/blog/images/CAMLBoy-bench-170w~pvdkBjmCgsHuSyhKqJaiKg.webp 170w, /blog/images/CAMLBoy-bench-340w~LlUceMayGLWSq6XXeyBC4w.webp 340w, /blog/images/CAMLBoy-bench-680w~d9eYr8srGoj1k1-DB8Utog.webp 680w, /blog/images/CAMLBoy-bench-1360w~ZKIIldzmpp7-z09HOdethg.webp 1360w" alt="A graph in blue showing a delta of performance improvement"/></p>
...
<p><img src="https://tarides.com/blog/images/microbench-wsoo-1360w~GMMAz3M8DNJMAhG6MjH0yQ.webp" sizes="(min-width: 1360px) 1360px, (min-width: 680px) 680px, 100vw" srcset="/blog/images/microbench-wsoo-170w~8TZJGkaCxlERj9saTguzSQ.webp 170w, /blog/images/microbench-wsoo-340w~4gJYqVB-LyboeZRyoeqfVw.webp 340w, /blog/images/microbench-wsoo-680w~lzT6JOc40sAsGK8TT4d68Q.webp 680w, /blog/images/microbench-wsoo-1360w~GMMAz3M8DNJMAhG6MjH0yQ.webp 1360w" alt="A graph of benchmark comparisons showing improvements"/></p>
<h2>What&rsquo;s Next for Wasm_of_ocaml?</h2>
...
<p>Furthermore, another one of the team&rsquo;s goals is to test an implementation of effect handlers based on the Stack Switching proposal, you can find the details in <a href="https://github.com/ocsigen/js_of_ocaml/pull/1832">#1882</a>.</p>
<p>Lastly, the team has more work planned to improve the performance of both Js_of_ocaml and Wasm_of_ocaml in 2026.</p>
<h2>Until Next Time</h2>
<p>Remember to visit the manual on Ocsigen&rsquo;s website to learn more about <a href="https://ocsigen.org/js_of_ocaml/latest/manual/wasm_overview">Wasm_of_ocaml</a> and to get started with the compiler if you haven&rsquo;t already. The WSOO team is always keen to hear feedback and figure out how they can improve the user experience. Please share your thoughts and experiences with the compiler on OCaml&rsquo;s <a href="https://discuss.ocaml.org/">discussion forum</a>!</p>
