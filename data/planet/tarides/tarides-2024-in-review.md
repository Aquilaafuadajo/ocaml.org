...
stronger foundation for OCaml&rsquo;s growth. This report details our work,
...
<p><em>TL;DR &ndash; In 2024, Tarides focused on removing adoption friction with
...
Windows. Tarides&rsquo; community efforts included facilitating the creation of the first <a href="https://fun-ocaml.com/">FUN
...
<p><img src="https://tarides.com/blog/images/average-monthly-visits-1360w~QEQSqhe66fLVpZwWodcg1Q.webp" sizes="(min-width: 1360px) 1360px, (min-width: 680px) 680px, 100vw" srcset="/blog/images/average-monthly-visits-170w~-K2X8miQ2m4Exjf09SccJQ.webp 170w, /blog/images/average-monthly-visits-340w~0AzxURs4kcUEtyXXxu-8IQ.webp 340w, /blog/images/average-monthly-visits-680w~QCq11lK_fJtakF7LmXuV4Q.webp 680w, /blog/images/average-monthly-visits-1360w~QEQSqhe66fLVpZwWodcg1Q.webp 1360w" alt="Average Monthly Visits"/></p>
...
users&mdash;especially newcomers&mdash;to adopt OCaml and build projects with
...
patches to core OCaml projects to make them relocatable &ndash; and we
...
feedback has been promising (the Preview&rsquo;s NPS went from +9 in Q3
...
other popular editors like Emacs and Vim&mdash;used by many Tarides
engineers&mdash;on a best-effort basis. Improvements to
...
<p><img src="https://tarides.com/blog/images/total-vscode-plugin-installations-1360w~zl9hCa9ruBd7ugqHXK6h3Q.webp" sizes="(min-width: 1360px) 1360px, (min-width: 680px) 680px, 100vw" srcset="/blog/images/total-vscode-plugin-installations-170w~hdPoXyMAmZfIYDi_c0OHCw.webp 170w, /blog/images/total-vscode-plugin-installations-340w~peo1_zNfD1C37nIzdZTJTQ.webp 340w, /blog/images/total-vscode-plugin-installations-680w~mbkoqq3xjRtrVnmVtcJwvA.webp 680w, /blog/images/total-vscode-plugin-installations-1360w~zl9hCa9ruBd7ugqHXK6h3Q.webp 1360w" alt="Total VSCode Plugin Installation"/></p>
...
IDE</a>&ndash;128k
installs,
<a href="https://marketplace.visualstudio.com/items?itemName=hackwaly.ocaml">Hackwaly</a>&ndash;90k
installs), our <a href="https://marketplace.visualstudio.com/items?itemName=ocamllabs.ocaml-platform">OCaml VS Code
plugin</a>
&ndash;now with over 208k downloads&ndash; is a key entry point for developers
...
refactoring significantly easier&mdash;especially in large
...
<a href="https://github.com/ocaml/odoc"><code>odoc</code></a>, OCaml&rsquo;s main documentation
...
<p>OCaml&rsquo;s error messages remain a common pain point, particularly for
syntax errors. Unlike <a href="https://doc.rust-lang.org/error_codes/error-index.html">Rust&rsquo;s error
index</a>, OCaml
...
that users wouldn&rsquo;t encounter errors when installing a package from
the community. This required catching issues early&mdash;before packages are
...
ecosystem.</p>
<p>In 2024, Tarides&rsquo; CI infrastructure supported the OCaml community at
...
and configurations, including OCaml&rsquo;s Tier 1 platforms: x86, ARM,
RISC-V, s390x, and Power. It played a critical role during major
events, such as new OCaml releases, by validating the ecosystem&rsquo;s
...
the first &ldquo;stable&rdquo; release of the multicore series. While some
...
tools to help identify and address subtle issues in OCaml&rsquo;s runtime
...
ephemerons</a>,
the suite has become an integral part of OCaml&rsquo;s development
...
<p><img src="https://tarides.com/blog/images/false-alarms-plot-errors-only-1360w~wOpCubYg66VDTbHXaZMcZw.webp" sizes="(min-width: 1360px) 1360px, (min-width: 680px) 680px, 100vw" srcset="/blog/images/false-alarms-plot-errors-only-170w~IFbjA34MDeLb0wgBXj_1hw.webp 170w, /blog/images/false-alarms-plot-errors-only-340w~vlfDw7tQOBgDsp6gGIR8BQ.webp 340w, /blog/images/false-alarms-plot-errors-only-680w~_PQ2HNF7F8Dui3zZ4MHnlw.webp 680w, /blog/images/false-alarms-plot-errors-only-1360w~wOpCubYg66VDTbHXaZMcZw.webp 1360w" alt="A stacked histogram illustrating the outcome of CI workflow runs split, focusing only on the 'ci', 'genuine', and 'other' error categories"/></p>
...
data races in the
runtime</a>. This
work has improved the safety and reliability of OCaml&rsquo;s multicore
...
(Wasm). <code>js_of_ocaml</code> (JSOO) has long been the backbone of OCaml&rsquo;s web
...
programming, continue to push the boundaries of what&rsquo;s possible with
...
support for it critical to OCaml&rsquo;s growth. In 2024, <strong>31% of visitors
to <a href="https://ocaml.org">ocaml.org</a></strong> accessed the site from Windows,
yet the platform&rsquo;s support historically lagged behind Linux and
...
2024&mdash;simplified installation, improved tooling, and continuous package
testing&mdash;represent a significant step forward.</p>
...
YouTube</a> (for more details, you can check out our dedicated <a href="https://tarides.com/blog/2024-11-13-the-new-conference-on-the-block-what-is-fun-ocaml/">blog post on FUN OCaml</a>). Tarides also co-chaired the OCaml Workshop at <a href="https://icfp24.sigplan.org/">ICFP
...
&ndash;including us&ndash; even in non-MirageOS context) and <a href="https://github.com/sponsors/dbuenzli">Daniel
B&uuml;nzli</a>, whose libraries like
...
over 100k views). These events expanded OCaml&rsquo;s visibility to new
audiences and contexts, introducing the language to a broader
technical community that &ndash;we hope&ndash; will discover OCaml and enjoy using
...
safety-critical systems. Built on MirageOS and OCaml&rsquo;s
...
in 2025!</p>
<p>I&rsquo;d like to personally thank our sponsors and customers, especially
...
in 2024 to make all of this happen: thank you. I&rsquo;m truly lucky to be
...
services</a> for open-source projects &ndash;
